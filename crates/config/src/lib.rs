...
pub use {
    ...
    loader::{
        ...
        guidelines_path, heartbeat_path, home_dir, host_data_dir_hint, identity_path,
        ...
        set_data_dir, set_host_data_dir_hint, set_share_dir, share_dir, soul_path, tools_path,
